...
+(UIImage*)imageWithIcon:(NSString*)identifier backgroundColor:(UIColor*)bgColor iconColor:(UIColor*)iconColor andSize:(CGSize)size{
    ...
    @autoreleasepool {
        ...
        fontSize = fa_constraintLabelToSize(label, CGSizeMake(size.height-13, size.width-13), 500, 5);
        font = label.font;
    }
    [iconColor setFill];
    ...
    [textContent drawInRect:CGRectMake(0, 5, size.width, size.height) withAttributes:@{NSFontAttributeName : font,
